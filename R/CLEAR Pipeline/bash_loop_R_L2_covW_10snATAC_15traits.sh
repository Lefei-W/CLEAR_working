...
# launch run_clear_pair.R on all 10 snATAC x 15 trait combinations (150 jobs)

WD=/working/lab_jonathb/lefeiW/projects/CLEAR_2026
SD=${WD}/jobs
OD=${WD}/output
RSCRIPT=${WD}/R/run_clear_pair.R
...
cd ${OUTDIR}
Rscript ${RSCRIPT} ${SE_NAME} ${SE_PATH} ${TRAIT_NAME} ${TRAIT_PATH}
EOF
